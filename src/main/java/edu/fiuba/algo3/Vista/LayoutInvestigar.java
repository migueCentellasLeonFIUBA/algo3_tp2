...
public class LayoutInvestigar extends Pane{
    ...
    private VBox crearBotones(VBox rightSide, Text pista){
        ...
        BotonVisitarEdificioEventHandler botonAeropuertoHandler = new BotonVisitarEdificioEventHandler(edificios.get(0), jugador, leftSide, pista, stage);
        ...
        BotonVisitarEdificioEventHandler botonBancoHandler = new BotonVisitarEdificioEventHandler(edificios.get(1), jugador, leftSide, pista, stage);
        ...
        BotonVisitarEdificioEventHandler botonBibliotecaHandler = new BotonVisitarEdificioEventHandler(edificios.get(2), jugador, leftSide, pista, stage);
